...
from data_extraction.utils.extraction_functions import extract_single_step_data_separate_embeddings
...
def main():
    ...
    OUTPUT_DIR = "/home/morg/students/idoavnir/Isaac-GR00T-fork/separated_embeddings_data"
    EMBODIMENT_TAG = "gr1"
    ...
    try:
        ...
        extract_batches(policy, OUTPUT_DIR, extraction_function=extract_single_step_data_separate_embeddings)
